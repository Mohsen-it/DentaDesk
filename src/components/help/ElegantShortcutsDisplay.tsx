...
const shortcuts: ShortcutItem[] = [
  ...
  { key: '3', arabicKey: '٣', description: 'المدفوعات', icon: <DollarSign className="w-3 h-3" />, category: 'تنقل' },
  { key: '4', arabicKey: '٤', description: 'المختبرات', icon: <Settings className="w-3 h-3" />, category: 'تنقل' },
  { key: '5', arabicKey: '٥', description: 'العلاجات السنية', icon: <Settings className="w-3 h-3" />, category: 'تنقل' },
  { key: '6', arabicKey: '٦', description: 'مصروفات العيادة', icon: <Settings className="w-3 h-3" />, category: 'تنقل' },
  { key: '7', arabicKey: '٧', description: 'التقارير', icon: <Settings className="w-3 h-3" />, category: 'تنقل' },
  { key: '8', arabicKey: '٨', description: 'الإعدادات', icon: <Settings className="w-3 h-3" />, category: 'تنقل' },
